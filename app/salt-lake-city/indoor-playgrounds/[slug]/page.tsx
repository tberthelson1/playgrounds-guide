...
export default function VenuePage() {
  ...
  useEffect(() => {
    ...
    document.title = `${venue.Name} – Indoor Playground in Salt Lake City`;
    ...
    meta.setAttribute(
      "content",
      `${venue.Name} is an indoor playground in Salt Lake City. See hours, pricing, age range, and what parents should know before visiting.`
    );
  }, [venue]);
  ...
  return (
    <main style={{ padding: "2rem", maxWidth: "800px" }}>
      ...
      <p>
        <a href="/salt-lake-city/indoor-playgrounds">
          ← Back to all indoor playgrounds in Salt Lake City
        </a>
      </p>
    </main>
  );
